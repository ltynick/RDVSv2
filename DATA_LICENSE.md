# RDVSv2 Dataset License and Third-Party Content Notice
...
To the extent that the RDVSv2 authors own or control the applicable
copyright and related rights, the following materials created by the
RDVSv2 authors are referred to as the “Licensed Materials”:

- salient-object segmentation masks;
- eye-tracking-guided annotations;
- manually created labels and attribute annotations;
- training, validation, and test splits;
- dataset metadata and index files;
- dataset statistics; and
- dataset documentation.

The selection and arrangement of the above materials are also included
to the extent that they are protected by applicable copyright or
database rights and owned or controlled by the RDVSv2 authors.
...
```bibtex
@article{li2026rdvsv2,
  title   = {RDVSv2: A Large-scale Benchmark for RGB-D Video
             Salient Object Detection},
  author  = {Li, Tianyu and He, Jiaohao and Fu, Keren and
             Zhao, Qijun},
